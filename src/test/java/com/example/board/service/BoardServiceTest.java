...
//                .extracting("id", "title", "content", "createdAt", "userId")
//                .containsExactly(1L, "테스트 제목1", "테스트 내용1", now, 1L);
//
//        assertThat(result.get(1))
//                .extracting("id", "title", "content", "createdAt", "userId")
//                .containsExactly(2L, "테스트 제목2", "테스트 내용2", now, 2L);
//
...
//
//        // when
//        boardService.createBoard(requestBoardDto, 1L);
//
//        // then
...
//        // given
//        Board board = new Board(1L, "title", "content", 0, LocalDateTime.now(), null, 1L);
